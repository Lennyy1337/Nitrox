    ...
    public partial class MainWindow : Window, INotifyPropertyChanged
    {
        ...
        public MainWindow()
        {
            ...
            Loaded += (sender, args) =>
            {
                ...
                LauncherNotifier.Info("Made by Lennyy1337!");
                ...
                {
                    LauncherNotifier.Info("Nitrox does not support pirated version of Subnautica, but we dont care!");
                    LauncherNotifier.Info("Hehe Pirate power!");
